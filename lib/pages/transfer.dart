                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        backgroundColor:Color(0xFFf65433),
                            ...
                            Text("To"),
                            Text(account_name,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
                            Text("("+account_no+")")
                          ],
                        ),
                      ),
                        ...
                        child: Container(
                         ...
                         child: Column(
                           children: [
                             ...
                             Divider(),
                             Text("Available Balance:"+"N" + currencyFormatter.format(balance)),
                             if(hold_amount>balance)
...
alignment: Alignment.bottomCenter,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("to "+account_name.toString()+"("+account_no.toString()+")",style: TextStyle(fontWeight: FontWeight.bold),),
                  const SizedBox(height: 100),
                  const Text('Enter your transaction pin complete',style: TextStyle(color: Colors.grey,fontSize: 16),),
                  const SizedBox(height: 10),
                  Expanded(
                    child: PinCodeWidget(
                      buttonColor: Colors.white,
                      numbersStyle: const TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.bold),
                      minPinLength: 6,
                      maxPinLength: 6,
 ...
 if(hold_amount>5){
   return OutlinedButton(
     ...
     child: Padding(
         padding: EdgeInsets.all(10),
         child: Text("Proceed",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 16),)),
   );
 }else{
   return OutlinedButton(
     style: OutlinedButton.styleFrom(
             ...
             title: Center(
               child: Row(
                ...
                Align(
                  ...
                  child: Text("Information Confirmed",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                ),
                   Expanded(
                     child:  Align(
             ...
             content: Container(
               ...
               child: Column(
                 children: [
                   ...
                   Row(
                     children: [
                       Text("Account No",style: TextStyle(fontSize: 13),),
                       Expanded(
                         child:  Align(
                           alignment: Alignment.topRight,
                   ...
                   Row(
                     children: [
                       Text("Account Name",style: TextStyle(fontSize: 13),),
                       Expanded(
                         child:  Align(
                           alignment: Alignment.topRight,
                   ...
                   Container(
                     ...
                     child: OutlinedButton(
                       child: Padding(
                         padding: EdgeInsets.all(10),
                         child: Text('Confirm', style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 16)),
                       ),
                       style: OutlinedButton.styleFrom(
                           backgroundColor: Colors.blue.shade900,
